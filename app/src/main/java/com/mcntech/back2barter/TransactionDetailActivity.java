...
public class TransactionDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            //arguments.putString(TransactionDetailFragment.ARG_ITEM_ID, getIntent().getStringExtra(TransactionDetailFragment.ARG_ITEM_ID));
            TransactionEx item = getIntent().getExtras().getParcelable("transaction");
            arguments.putParcelable("transaction", item);
